...
<Tabs>
  ...
  <Tab title="Agent Builder User">
    **Definition:** An end-user of an agent created by an Agent Builder
    **Platform Interaction:** Limited to OAuth consent pop-ups from 3rd-party
    SaaS providers **Typical Workflow:** 1. Use the Agent Builder's application
    2. When prompted, authorize access to their SaaS tools (Salesforce, Slack,
    etc.) 3. Complete OAuth consent flow 4. Return to Agent Builder's
    application **Example Use Case:** A sales manager using their company's AI
    assistant who needs to grant access to their Salesforce account
  </Tab>
