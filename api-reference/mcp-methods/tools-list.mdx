...
| -------- | -------------- | --------------------------------------------- |
| `-32602` | Invalid params | Check request format and required parameters  |
...
- **Execute a tool** using [`tools/call`](./tools-call)
- **Get argument completions** using `completion/complete`
- **Subscribe to changes** via `notifications/tools/list_changed`
