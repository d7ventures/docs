...
For production applications requiring seamless user experience, Kambrium supports white-label OAuth flows that maintain your brand identity throughout the authentication process.

<Card
  title="White-Label OAuth Guide"
  icon="palette"
  href="/authentication/white-labeling"
>
  Complete guide to embedding branded OAuth flows in your application
</Card>
